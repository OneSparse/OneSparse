...
ERROR:  function random_matrix(integer, integer, integer, integer, integer, boolean, numeric) does not exist
LINE 1: create materialized view rgraph as select triu(random_matrix...
                                                       ^
HINT:  No function matches the given name and argument types. You might need to add explicit type casts.
create materialized view urgraph as select random_matrix(8, 8, 28, 1, 10, true, 0.22) > 0 as graph;
ERROR:  function random_matrix(integer, integer, integer, integer, integer, boolean, numeric) does not exist
LINE 1: create materialized view urgraph as select random_matrix(8, ...
                                                   ^
HINT:  No function matches the given name and argument types. You might need to add explicit type casts.
...
ERROR:  relation "rgraph" does not exist
LINE 1: ...andom Weighted Directed Graph') as col_a_source from rgraph 
                                                                ^
...
ERROR:  relation "urgraph" does not exist
LINE 1: ...om Weighted Undirected Graph') as col_b_source from urgraph 
                                                               ^
```
...
ERROR:  relation "urgraph" does not exist
LINE 1: ... 1)), false, false, true, 0.5) as col_b_source from urgraph 
                                                               ^
```
<table style="width: 100%; table-layout: fixed;" class="dot-table">
  <tr>
...
ERROR:  relation "rgraph" does not exist
LINE 1: ...int, 1), true, true, true, 0.5) as col_a_source from rgraph 
                                                                ^
select draw(triu(graph), sssp(graph, 1::bigint, 1), true, false, true, 0.5) as col_b_source from urgraph \gset
ERROR:  relation "urgraph" does not exist
LINE 1: ...t, 1), true, false, true, 0.5) as col_b_source from urgraph 
                                                               ^
```
<table style="width: 100%; table-layout: fixed;" class="dot-table">
  <tr>
