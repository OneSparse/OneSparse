...
static Size
unaryop_get_flat_size(ExpandedObjectHeader *eohptr)
{
	os_UnaryOp *unaryop;
...
Datum
expand_unaryop(os_FlatUnaryOp * flat, MemoryContext parentcontext)
{
	os_UnaryOp *unaryop;
