...
os_IndexBinaryOp* DatumGetIndexBinaryOp(Datum datum)
{
	os_IndexBinaryOp *indexbinaryop;
	os_FlatIndexBinaryOp *flat;
...
Datum indexbinaryop_in(PG_FUNCTION_ARGS)
{
	os_IndexBinaryOp *indexbinaryop;
	char* input;
...
Datum indexbinaryop_out(PG_FUNCTION_ARGS)
{
	char *result;
	os_IndexBinaryOp *indexbinaryop;
...
Datum indexbinaryop_name(PG_FUNCTION_ARGS)
{
	os_IndexBinaryOp *indexbinaryop;
	indexbinaryop = OS_GETARG_INDEXBINARYOP(0);
